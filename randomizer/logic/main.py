...
class GameWorld:
    ...
    def build_patch(self):
        ...
        if self.settings.is_flag_enabled(flags.ShuffleBowsersKeep):
            ...
            # patch 3350 to 332
            event_patch_data = []
            ...
            event_patch_data = [0xA8, 0x2B, 0x0A, 0xC3, 0xE2, 0xD2, 0x01, 0xB3, 0x7A, 0xE2, 0xD2, 0x01, 0xBB, 0x7A, 0xE2, 0xD2, 0x01, 0xC3, 0x7A, 0xE2, 0xD2, 0x01, 0xCB, 0x7A, 0xE2, 0xD2, 0x01, 0xD3, 0x7A, 0xE2, 0xD2, 0x01, 0xDB, 0x7A, 0xB0, 0x2D, 0x01, 0x00, 0xD0, 0x1A, 0x0D, 0xFE, 0xB0, 0x2D, 0x05, 0x00, 0xD0, 0x1A, 0x0D, 0xFE, 0xB0, 0x2D, 0x09, 0x00, 0xD0, 0x1A, 0x0D, 0xFE, 0xB0, 0x2D, 0x0D, 0x00, 0xD0, 0x1A, 0x0D, 0xFE, 0xB0, 0x2D, 0x11, 0x00, 0xD0, 0x1A, 0x0D, 0xFE, 0xB0, 0x2D, 0x15, 0x00, 0xD0, 0x1A, 0x0D, 0xFE]
            patch.add_data(0x1F7A91, event_patch_data)
            i = 0x1F7A91 + len(event_patch_data)
            while i < 0x1F7B0C:
                patch.add_data(i, 0x9B)
                i += 1
            patch.add_data(0x1F7B0C, 0xFE)

            # fix Z-platform room failing to reload on failure
            ...
            # remove any 10-try set events from rooms
            ...
            for index, door in enumerate(doors):
                ...
                patch.add_data(0x1f7A96 + (index * 5), door[0].relative_room_id)
                patch.add_data(0x1f7AB8 + (index * 8), door[0].original_event)
                patch.add_data(door[0].original_event_location, [0x49, 0x08])
                for j in range(0, len(door)):
                    if (j + 1 < len(door)):
                        patch.add_data(door[j+1].memory_700A_jump_address, 1 + (index * 4) + j)
                        patch.add_data(door[j+1].memory_700A_load_address, 1 + (index * 4) + j + 1)
