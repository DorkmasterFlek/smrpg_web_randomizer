...
class GameWorld:
    ...
    def build_patch(self):
        ...
        if self.settings.is_flag_enabled(flags.ShuffleBowsersKeep):
            ...
            event_patch_data = [0xE4, 0x65, 0x00, 0x00, 0xBB, 0x7A, 0xE4, 0x2D, 0x01, 0x00, 0xBE, 0x7A, 0xE4, 0x2D, 0x05, 0x00, 0xBE, 0x7A, 0xE4, 0x2D, 0x09, 0x00, 0xBE, 0x7A, 0xE4, 0x2D, 0x0D, 0x00, 0xBE, 0x7A, 0xE4, 0x2D, 0x11, 0x00, 0xBE, 0x7A, 0xE4, 0x2D, 0x15, 0x00, 0xBE, 0x7A, 0xA8, 0x2B, 0x0A, 0xC3, 0xE2, 0xCF, 0x01, 0xDD, 0x7A, 0xE2, 0xD3, 0x01, 0xE5, 0x7A, 0xE2, 0xC8, 0x01, 0xED, 0x7A, 0xE2, 0xD1, 0x01, 0xF5, 0x7A, 0xE2, 0xD2, 0x01, 0xFD, 0x7A, 0xE2, 0xC9, 0x01, 0x05, 0x7B, 0xB0, 0x2D, 0x01, 0x00, 0xD0, 0x1A, 0x0D, 0xFE, 0xB0, 0x2D, 0x05, 0x00, 0xD0, 0x0F, 0x00, 0xFE, 0xB0, 0x2D, 0x09, 0x00, 0xD0, 0x2C, 0x07, 0xFE, 0xB0, 0x2D, 0x0D, 0x00, 0xD0, 0x1E, 0x0D, 0xFE, 0xB0, 0x2D, 0x11, 0x00, 0xD0, 0x24, 0x0D, 0xFE, 0xB0, 0x2D, 0x15, 0x00, 0xD0, 0x2B, 0x07, 0xFE]
            ...
            for index, door in enumerate(doors):
                ...
                patch.add_data(0x1f7ABA + (index * 5), door[0].relative_room_id)
                patch.add_data(0x1f7ADC + (index * 8), door[0].original_event)
        ...
        # sixdoor_patch = [0xD2, 0x9E, 0x5C]
        # patch.add_data(0x205C42, sixdoor_patch)
        ...
        # SEED TESTING ONLY - marios pad warps to bowsers keep
